  ...
  return (
    <div className="flex justify-center mt-24  px-4">
      <form onSubmit={handleLogin} className="bg-white p-6 rounded-lg shadow-md w-full max-w-sm">
        ...
        <Button type="submit" disabled={loading} className="w-full mb-3">{loading ? "Logging in..." : "Login"}</Button>
        <div className="flex gap-2">
        <p className="">Don't have an Account </p>
        <p onClick={handleClick} className="text-neutral-500 underline underline-offset-4 cursor-pointer">Signup</p>
        </div>
      </form>
    </div>
  );
